...
function viewIcons() {
  ...
  down_icon.id = "down";
  let baseURL = "../assets/Icons/Selected-"; // url for adding icons
  ...
  for (let i = 0; i < 3; i++) {
    ...
    img_1.src = `./assets/Icons/Unselected-${i + 1}.svg`;
    img_2.id = "img-active";
    img_2.src = `./assets/Icons/Selected-${i + 1}.svg`
