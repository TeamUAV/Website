    ...
    list: [
      {
        ...
        about:
          "I see myself an ever passionate person for Team UAV and Creation Labs and I guess, back in the campus, more than at my room, the Lab is the place where you will find me most of the time. It's because I feel that the Lab is a genuine place to brainstorm about new ideas/products and engineer them. Apart from all this I love playing and talking about poker, gambling mathematics, spacesuits, Mahabarat, products and startups! Ahoo (UAV version of Salyud!)",
        positionsHeld: [
          "Deputy Manager",
          "Structural Engineer",
          "Mechanical Engineer",
        ...
        imgSrc: "Pages/About/knowMorePage/Assets/Board Members/sparsh.jpeg",
        contact: [
          {
            body: "LinkedIn",
      ...
      },
      {
        ...
        name: "Amartya Vatsa",
        skillSet:
          "Python, R, Exploratory Data Analysis, Embedded Systems, Machine Learning, GCP Big Data Level 2, Cloud Computing".split(
            ", "
          ),
        about:
          "Dedicated and willing to learn new skills every passing day. Passionate about embedded systems and its application.",
        ...
        contact: [
          {
            body: "LinkedIn",
            ref: "http://www.linkedin.com/in/amartyaaaaaa/",
          },
          {
            body: "GitHub",
            ref: "https://github.com/amartyaaaa",
          },
          {
            body: "GCP",
            ref: "https://www.qwiklabs.com/public_profiles/4dee56e6-259b-45b9-a413-e7bb7c1b0c07 ",
          },
        ],
      },
      {
        ...
        name: "Kartik Gulati",
        skillSet:
          "Solidworks , fusion 360 , composites , Product Designing , XFLR 5 , Aerodynamic designing , Propulsion systems , Graphic Designing , c++ , Interactive Designing".split(
            " , "
          ),
        about:
          "I see myself as a highly motivated individual  fascinated by engines and thrived by creativity , i have always seen this world with a whole new perspecctive .",
        positionsHeld:
          "Mechanical Engineer , Design and Propulsion engineer".split(" , "),
        callSign: "KK",
      ...
      },
      {
        ...
        name: "Kanav Bhasin",
        skillSet:
          "Java, Python, Embedded Systems, Microcontrollers, MATLAB, PCB Designing, Simulink".split(
            ", "
          ),
        about:
          "A dedicated engineer, pursuing Electrical and Electronics Engineering (EEE) from VIT Vellore",
        positionsHeld: ["Avionics Engineer"],
        callSign: "",
      ...
      },
      {
        ...
        name: "Aritra Sanyal ",
        skillSet:
          "Mechanical design,systems design,solidworks,fusion 360,ANSYS,Aeronautical design,project management,MATLAB,product design".split(
            ","
          ),
      ...
      },
      {
        ...
        skillSet:
          "HTML5, CSS3, JavaScript, Autodesk Fusion 360, Python, XFLR5, Matlab Simulink, Animoto, Marketing and Advertising, Social Media Expertise".split(
            ", "
          ),
      ...
      },
      {
        ...
        skillSet:
          "Python, Flutter, Java, C/C++, Machine Learning, Image Processing, HTML, CSS, JavaScript".split(
            ", "
          ),
      ...
      },
      {
        ...
        name: "Hrithik Dhoka",
        skillSet:
          "Python, Java, Machine Learning, Deep Learning, SQL, HTML, CSS, Javascript, Apex".split(
            ", "
          ),
      ...
      },
      {
        ...
        name: "Neel Agarwal",
        skillSet:
          "Ansys, Fusion 360, Solid-works, Additive Manufacturing, Ultimate- Cura, Computational Dynamics".split(
            ", "
          ),
    ...
    list: [
      {
        ...
        name: "Gaurav Singh",
        skillSet:
          "C Programming, C++, Java, Python, HTML, CSS, JavaScript, NodeJS, ElectronJS, PHP, Rust, R, SQL, DSA, Machine Learning, Shell-Scripting, Embedded Systems, Dart, Flutter".split(
            ", "
          ),
        about:
          "A simple Guy who loves to sit in front of a computer and code, code and coffee keep me going for hours. (creator of this site)",
        positionsHeld: ["Avionics Engineer"],
        callSign: "The Doctor",
        ...
        contact: [
          {
            body: "Github",
            ref: "https://github.com/Gaurav4604",
          },
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/gaurav-singh-8737701a4/",
          },
          {
            body: "HackerRank",
            ref: "https://www.hackerrank.com/gp5in9h",
          },
        ],
      },
      {
        listTitle: "Sai Santosh Thatikonda",
        name: "Sai Santosh Thatikonda",
        skillSet:
          "Aerodynamics, Design, Finance, Solidworks, Autodesk Fusion 360, Ansys, Cura, Python".split(
            ", "
          ),
        about:
          "I consider myself to be an higly ambitious person with a desire to learn and grow both personally and professionally, My passion for classical physics motivated me to pursue Mechanical Engineering.",
        ...
        contact: [
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/sai-santosh-thatikonda-0aa97a18b/",
          },
          {
            body: "Instagram",
            ref: "https://www.instagram.com/sai_santosh_10/",
          },
        ],
      },
      {
        ...
        name: "Hardik Shukla",
        skillSet:
          "Aerodynamics, CAD, Graphic designing, Solidworks, Autodesk Fusion 360, Ansys, Cura, Python, PTC Creo".split(
            ", "
          ),
        positionsHeld: [
          "Structural Engineer, Deputy Manager and Mechanical Engineer",
        ],
        callSign: "Maverick",
        ...
        contact: [
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/hardik-shukla-4aa9771b2/",
          },
          {
            body: "Instagram",
            ref: "https://www.instagram.com/___hardikk/",
          },
        ],
      },
      {
        ...
        skillSet:
          "Aerodynamics, Design, Autodesk Inventor, Solidworks, Autodesk Fusion 360, Ansys, Cura, Python".split(
            ", "
          ),
        positionsHeld: ["Design Engineer and Deputy Manager"],
        callSign: "FlyDoc",
        ...
        contact: [
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/akshay-badagabettu-ba8b7a18b/",
          },
          {
            body: "Instagram",
            ref: "https://instagram.com/akshay__14___/",
          },
        ],
      },
      {
        listTitle: "Sai Sravan Yarlagadda",
        name: "Sai Sravan Yarlagadda",
        skillSet:
          "Aerodynamics, Design, Solidworks, Autodesk Fusion 360, Ansys, Cura, Python, Java".split(
            ", "
          ),
        positionsHeld:
          "Composites Engineer ,Deputy Manager, Mechanical Engineer".split(
            ", "
          ),
        callSign: "",
        ...
        contact: [
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/sai-sravan-yarlagadda-946073199/",
          },
          {
            body: "Instagram",
            ref: "https://www.instagram.com/ysaisrav/",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        name: "Anmol Khantaal",
        skillSet:
          "Python, C Programming, MATLAB, Machine Learning, R, Arduino Programming".split(
            ", "
          ),
        positionsHeld: "Avionics Engineer".split(", "),
        callSign: "MercuriuM",
      ...
      },
      {
        ...
        name: "Gokul Dinesh",
        skillSet:
          "Java, Python, C/C++ Programming, MATLAB, SQL, PHP, JavaScript".split(
            ", "
          ),
        positionsHeld: "Avionics Engineer".split(", "),
        callSign: "Goks",
        about: ``,
        imgSrc: "Pages/About/knowMorePage/Assets/Senior Core/gokul.jpeg",
        contact: [
          {
            body: "LinkedIn",
            ref: "https://www.linkedin.com/in/gokul-dinesh",
          },
          {
            body: "Instagram",
      ...
      },
      {
        ...
        name: "Ujjwal Nasra",
        skillSet:
          "C Programming, Java, After Effects, Embedded Systems, Python".split(
            ", "
          ),
        positionsHeld: "Avionics Engineer".split(", "),
        callSign: "Firebolt",
      ...
      },
      {
        ...
        positionsHeld:
          "Composites and manufacturing department, Mechanical engineer".split(
            ", "
          ),
        callSign: "Gleipmir",
